    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block text-success">
        <ul>
          ...
          <li class="{{ (request()->is('dijual*')) ? 'active' : '' }}"><a href="{{ route('dijual') }}">Properti Dijual</a></li>
          <li class="{{ (request()->is('disewakan*')) ? 'active' : '' }}"><a href="{{ route('disewakan') }}">Properti Disewakan</a></li>          
        </ul>
      </nav><!-- .nav-menu -->
