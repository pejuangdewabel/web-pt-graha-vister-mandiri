    ...
    <div class="container d-flex align-items-center">
      ...
      <nav class="nav-menu d-none d-lg-block text-success">
        <ul>
          ...
          <li><a href="courses.html">Properti Dijual</a></li>
          <li><a href="trainers.html">Properti Disewakan</a></li>

        </ul>
      </nav><!-- .nav-menu -->

      <a href="courses.html" class="get-started-btn bg-success">Login</a>
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12 footer-contact">
            <h3>Alamat</h3>
            <p>
              Jl. Tirtayasa Jl. Sultan Agung, Sepang Jaya<br>
              Kedaton<br>
              Bandar Lampung <br><br>
              <strong>Phone:</strong> +1 5589 55488 55<br>
              <strong>Email : </strong> ptgrahavistermandiri@gmail.com<br>
            </p>
          </div>
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="mr-md-auto text-center text-md-left">
        <div class="copyright">
          &copy; Copyright 2021<strong><span></span></strong>. All Rights Reserved
        </div>
      </div>
